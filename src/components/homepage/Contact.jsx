    ...
    >
      ...
      <div ref={contactSection} className="mt-10 flex flex-col gap-20 md:grid md:grid-cols-6 md:px-12">
        <div className="col-span-4">
          ...
          Excited to explore new opportunities and collaborate on innovative projects. Available for hire and excited to embark on new opportunities</p>
          <form
            name="contact"
            ...
            method="POST" 
          >
            <input type="hidden" name="access_key" value="a4b36d8c-d48e-45c9-ae41-3ce745dc15f1"></input>
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <a
                ...
                target="_blank"
                rel="noreferrer"
                //onClick={(e) => {window.location.href ='mailto:example@email.com';}}
              >
              ...
              <a
                ...
                // }}
              >
                <span>prabhusatyam4.4@gmail.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <a
                href="https://www.linkedin.com/in/prabhu-satyam/"
              ...
              <a
                href="https://github.com/prabhu4444"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://leetcode.com/prabhu4444/"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
                <Icon icon="simple-icons:leetcode" color="#666" />
                <div className="relative">
                  <span>Leetcode</span>
                  <span className="absolute bottom-0 left-0 h-[0.10em] w-0 rounded-full bg-secondary-600 duration-300 ease-in-out group-hover:w-full"></span>
                </div>
